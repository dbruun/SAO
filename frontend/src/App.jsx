...
export default function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/api/verification`, { method: 'POST', body: form })
  ...
  return (
    <div className="container">
      ...
      <p className="subtitle">Upload a driver's license and enter your details to verify identity</p>
      ...
      <div className="hint">
        ...
        Use these values for a PASS: Name <em>John Michael Smith</em>, Address <em>123 Main Street, Springfield, IL 62701</em>, DOB <em>1985-06-15</em>.
      </div>
      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FileUpload id="fileBack"  label="ID Back"  required={false} file={fileBack}  onChange={setFileBack}  />

          <div className="form-group">
            <label>Full Name *</label>
            <input type="text" value={fullName} onChange={e => setFullName(e.target.value)} placeholder="John Michael Smith" />
          </div>
          <div className="form-group">
            <label>Address *</label>
            <input type="text" value={address} onChange={e => setAddress(e.target.value)} placeholder="123 Main Street, Springfield, IL 62701" />
          </div>
          <div className="form-group">
      ...
      {loading && (
        <div className="card loading-card">⏳ Processing your document…</div>
      )}
